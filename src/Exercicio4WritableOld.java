...
public class Exercicio4WritableOld implements WritableComparable<Exercicio4WritableOld>
{
    double somaPreco;
    int ocorrencia;

    // Construtor vazio
    public Exercicio4WritableOld()
    {

    }

    // Construtor
    public Exercicio4WritableOld(double somaPreco, int ocorrencia)
    {
    ...
    @Override
    public int compareTo(Exercicio4WritableOld o)
    {
        // Sempre é assim
